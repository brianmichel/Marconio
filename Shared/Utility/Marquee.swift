...
struct MarqueeText : View {
    ...
    init(text: String, font: MFont, leftFade: CGFloat, rightFade: CGFloat, startDelay: Double, alignment: Alignment?) {
        self.text = text
        self.font = font
...
extension String {
    ...
    func widthOfString(usingFont font: MFont) -> CGFloat {
        let fontAttributes = [NSAttributedString.Key.font: font]
        let size = self.size(withAttributes: fontAttributes)
        return size.width
    }

    func heightOfString(usingFont font: MFont) -> CGFloat {
        let fontAttributes = [NSAttributedString.Key.font: font]
        let size = self.size(withAttributes: fontAttributes)
        return size.height
    }
